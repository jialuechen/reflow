...
public :
    ...
    virtual Eigen::ArrayXXd   stepOptimize(const   std::shared_ptr< libflow::SpaceGrid> &p_grid, const Eigen::ArrayXd   &p_stock,
                                           const std::vector< libflow::ContinuationCutsTree  > &p_condEsp) const = 0;
    ...
    virtual void stepSimulate(const std::shared_ptr< libflow::SpaceGrid>   &p_grid, const std::vector< libflow::ContinuationCutsTree  > &p_continuation,
