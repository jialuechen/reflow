...
#ifndef OPTIMIZERDPBASE_H
#define OPTIMIZERDPBASE_H
#include <Eigen/Dense>
...
/** \file OptimizerDPBase.h
 *  \brief Define an abstract class for Dynamic Programming problems solved by regression  methods
 *     \author Xavier Warin
 */
...
/// \class OptimizerDPBase OptimizerDPBase.h
///  Base class for optimizer for Dynamic Programming  with regression methods
class OptimizerDPBase : public OptimizerBaseInterp
{
...
public :
    ...
    ///              .
    virtual std::pair< Eigen::ArrayXXd, Eigen::ArrayXXd>   stepOptimize(const   std::shared_ptr< libflow::SpaceGrid> &p_grid, const Eigen::ArrayXd   &p_stock,
