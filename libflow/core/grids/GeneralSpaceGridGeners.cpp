...
bool GeneralSpaceGridGeners::write(ostream &p_of, const wrapped_base &p_base,
...
GeneralSpaceGrid *GeneralSpaceGridGeners::read(const gs::ClassId &p_id, istream &p_in) const
{
...
const gs::ClassId &GeneralSpaceGridGeners::wrappedClassId()
{
