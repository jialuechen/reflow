...
bool RegularLegendreGridGeners::write(ostream &p_of, const wrapped_base &p_base,
...
RegularLegendreGrid *RegularLegendreGridGeners::read(const gs::ClassId &p_id, istream &p_in) const
{
...
const gs::ClassId &RegularLegendreGridGeners::wrappedClassId()
{
