...
private :
    ...
    std::shared_ptr<reflow::OptimizerBaseInterp >          m_pOptimize ; ///< optimizer solving the problem for one point and one step
...
public :
    ...
    SimulateStepRegressionControl(gs::BinaryFileArchive &p_ar,  const int &p_iStep,  const std::string &p_nameCont,
                                  ...
                                  const  std::shared_ptr<reflow::OptimizerBaseInterp > &p_pOptimize
#ifdef USE_MPI
