...
struct RegularLegendreGridDerivedGeners: public gs::AbsReaderWriter<reflow::FullGrid>
{
...
gs_associate_serialization_factory(reflow::RegularLegendreGrid, StaticSerializationFactoryForFullGrid)
