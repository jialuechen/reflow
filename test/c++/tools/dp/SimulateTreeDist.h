...
#include "reflow/dp/SimulateStepTreeDist.h"
#include "reflow/dp/OptimizerDPBase.h"
#include "reflow/dp/SimulatorDPBase.h"

double SimulateTreeDist(const std::shared_ptr<reflow::FullGrid> &p_grid,
                        ...
                        const boost::mpi::communicator &p_world)
{
    ...
    {
        reflow::SimulateStepTreeDist(ar, nbStep - 1 - istep, nameAr, p_grid, p_optimize, p_bOneFile, p_world).oneStep(states, costFunction);
